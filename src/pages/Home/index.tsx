    ...
    return (
        <App>
            <ContainerFirst>
                <ContainerTextFirst>
                    <h2>Bem-vindo</h2>
                    <h3>Eu sou desenvolvedor de aprendizado de máquinas</h3>
                ...
                <ContainerPeopleFirst>
                    <img src={personal_picture_home_first} alt="Uma foto do dono do Site" />
                </ContainerPeopleFirst>
            </ContainerFirst>
            <ContainerSecond>
                <ContainerPeopleSecond>
                    <img src={personal_picture_home_second} alt="Uma foto do dono do Site" />
                </ContainerPeopleSecond>
                <ContainerTextSecond>
            ...
            <ContainerThrid>
                <ContainerFormation>
                    ...
                    <ul>
                        ...
                        <li><p>Faculdade:<br /><br />2017 - 2022<br />Bacharel em Ciência da Computação - Universidade Federal de Santa Maria</p></li>
                    </ul>
                </ContainerFormation>
                <ContainerLanguages>
                    <h1>IDIOMAS</h1>
                    <ul>
                        ...
                        <li>
                            <ContainerLanguage>
                                ...
                                <ContainerLanguageText><h3>Inglês</h3><br /><h4>Intermediário</h4></ContainerLanguageText>
                            </ContainerLanguage>
                        </li>
                        <li>
                            <ContainerLanguage>
                                <ContainerLanguageImage><img src={icon_usa} alt="Bandeira da Espanha" /></ContainerLanguageImage>
                                <ContainerLanguageText><h3>Espanhol</h3><br /><h4>Intermediário</h4></ContainerLanguageText>
                            </ContainerLanguage>
                        </li>
                    </ul>
                </ContainerLanguages>
